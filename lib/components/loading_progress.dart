...
class LoadingProgress extends StatefulWidget {
  ...
  const LoadingProgress({@required this.size, this.milliseconds: 300, this.color: Colors
      .green, this.count: 4});
...
class _ProgressState extends State<LoadingProgress> with TickerProviderStateMixin {
